...
public class ImageCaptionUpload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_caption_upload);


        Firebase.setAndroidContext(ImageCaptionUpload.this);
        ...
        SubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ImageGetSet category = new ImageGetSet();
