...
public class CaptionsRecyclerViewAdapter extends RecyclerView.Adapter<CaptionsRecyclerViewAdapter.ViewHolder>  {

    Context context;
    List<UploadCaption> MainImageUploadInfoList,filterList;


    public CaptionsRecyclerViewAdapter(Context context, List<UploadCaption> TempList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.caption_recyclerview_items, parent, false);
        ...
        holder.wp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Snackbar.make(v,"Whatsapp is not installed...",Snackbar.LENGTH_SHORT).show();
                }
            }
        });
